...
def WAR(request):
    ...
    hit_path = os.path.dirname('C:/COCO_AI_Web_Hackaton/COCO_92/appWAR/model/') + '\hitter_WAR.h5'
    hitterModel = tf.keras.models.load_model(hit_path)
    pit_path = os.path.dirname(
        'C:/COCO_AI_Web_Hackaton/COCO_92/appWAR/model/') + '\pitcher_WAR_allData.h5'
    ...
    if request.POST.get('hitterPitcher') == "selectHitter":
        ...
        train_path = os.path.dirname('C:/COCO_AI_Web_Hackaton/COCO_92/appWAR/model/') + '\X_train.csv'
    ...
    # Select에서 Pitcher를 선택했을 경우
        ...
        train_path = os.path.dirname(
            'C:/COCO_AI_Web_Hackaton/COCO_92/appWAR/model/') + '\Pitcher_X_train_allData.csv'
